...
#    slope = min(abs(l_slope), abs(r_slope))
#    if slope == 0:
#        return 5

#    speed = slope * 60.0 - 10.0
#    print(speed)
...
def start():
    ...
    pid = PID(0.5, 0.0005, 0.05) # Kp, Ki, Kd
    ...
    while True:
        ...
        # print("wmm_angle", wmm_angle)

        pid_angle = pid.pid_control(steer_angle)
